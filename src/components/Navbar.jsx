    ...
    <nav className='border-b border-gray-300'>
        <ul className='flex justify-between items-center backdrop-blur-lg p-3 max-w-6xl mx-auto'>
            ...
            <Link to='/' className='flex items-center gap-2 cursor-pointer md:-ml-32'>
                ...
                <span className="text-2xl text-pink-400 font-bold hidden md:block"> Shelfio </span>
            </Link>
            <li className='flex items-center gap-2'>
                <Link to="/create" className='bg-pink-400 text-white p-2 md:px-3 md:py-2 rounded-full md:rounded-2xl cursor-pointer flex items-center gap-1'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
